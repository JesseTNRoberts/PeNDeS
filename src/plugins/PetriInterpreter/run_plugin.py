"""
This script is called by the plugin-wrapper, PetriInterpreter.js, which passes down the
...
from PetriInterpreter import PetriInterpreter
...
plugin = PetriInterpreter(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
